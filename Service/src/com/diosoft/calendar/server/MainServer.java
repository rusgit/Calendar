...
//        LOG.info("Server started.");
        ...
        ApplicationContext factory = new ClassPathXmlApplicationContext("app-context-server.xml");
...
// Create and add events
        ...
        String[] descriptions1 = {"Mega Party", "It will be a great party!", "2020-09-08 15:00", "2020-09-08 19:00"};
        Event event1 = calendarService.createEvent(descriptions1, attenders);
        LOG.info("event created and added.");

        LOG.info("Creating and adding event...");
        String[] descriptions2 = {"Mega Party", "It will be a great party!", "2020-09-08 19:15", "2020-09-08 20:00"};
        Event event2 = calendarService.createEvent(descriptions2, attenders);
        LOG.info("event created and added.");

        LOG.info("Creating and adding event...");
        String[] descriptions3 = {"New Year", "Happy New Year!", "2020-01-01 00:00", "2020-01-03 00:01"};
