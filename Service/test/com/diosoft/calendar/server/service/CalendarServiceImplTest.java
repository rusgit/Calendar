...
//  empty list
    ...
    public void testSearchFreeTimeForEvent() throws OrderOfArgumentsException, IOException, ValidationException, DateTimeFormatException, JAXBException {
        ...
        List<LocalDateTime> timeList1 = new ArrayList<LocalDateTime>();
        timeList1.add(DateParser.stringToDate("2020-09-20 14:45"));
        timeList1.add(DateParser.stringToDate("2020-10-15 14:45"));

        List<LocalDateTime> timeList2 = new ArrayList<LocalDateTime>();
        timeList2.add(DateParser.stringToDate("2020-10-15 20:15"));
        timeList2.add(DateParser.stringToDate("2020-11-01 08:45"));

        List<LocalDateTime> timeList3 = new ArrayList<LocalDateTime>();
        timeList3.add(DateParser.stringToDate("2020-11-03 18:15"));
        timeList3.add(DateParser.stringToDate("2020-12-31 19:45"));

        List<LocalDateTime> timeList4 = new ArrayList<LocalDateTime>();
        timeList4.add(DateParser.stringToDate("2021-01-02 11:15"));
        timeList4.add(DateParser.stringToDate("2021-01-03 14:45"));
        ...
        List<List<LocalDateTime>> resultList = calendarService.searchFreeTimeForEvent(startDate ,endDate, duration);
        Assert.assertEquals(expectedList, resultList);
        verify(mockDataStore,times(106)).getEventByDay(Matchers.any(LocalDate.class));
    }
}
