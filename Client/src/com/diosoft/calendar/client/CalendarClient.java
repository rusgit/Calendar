...
public class CalendarClient {
    ...
    CalendarClient(CalendarService calendarService) {
        this.calendarService = calendarService;
    }

    public void emulateClient() throws RemoteException, DateTimeFormatException, OrderOfArgumentsException {
...
// Edit event
        if (calendarService.searchByTitle("Edited event").isEmpty()) {
            String[] descriptionsEditedEvent = {"Edited event", "It is edited event", "2025-09-07 15:00", "2025-09-07 19:00"};
            calendarService.createEvent(descriptionsEditedEvent, attenders, periodOnce);
        }
